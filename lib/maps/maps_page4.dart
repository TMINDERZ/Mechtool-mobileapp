...
class MapsPage4 extends StatefulWidget {
  const MapsPage4({super.key});
  static const String id = 'map_screen_4';

  @override
  State<MapsPage4> createState() => _MapsPage4State();
}

class _MapsPage4State extends State<MapsPage4> {
        ...
        builder: (context, snapshot) {
          ...
          return GoogleMap(
            initialCameraPosition: const CameraPosition(
              target: LatLng(6.91006395174441, 79.96741946504494),
              zoom: 13,
            ),
            polylines: {
              Polyline(
                  ...
                  points: [
                    userLocation,
                    const LatLng(6.91006395174441, 79.96741946504494),
                  ]),
            },
            markers: {
              Marker(
              ...
              Marker(
                ...
                position: const LatLng(6.91006395174441, 79.96741946504494),
                infoWindow: const InfoWindow(title: 'Soga Hardware'),
