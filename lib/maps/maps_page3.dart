...
class MapsPage3 extends StatefulWidget {
  const MapsPage3({super.key});
  static const String id = 'map_screen_3';

  @override
  State<MapsPage3> createState() => _MapsPage3State();
}

class _MapsPage3State extends State<MapsPage3> {
        ...
        builder: (context, snapshot) {
          ...
          return GoogleMap(
            initialCameraPosition: const CameraPosition(
              target: LatLng(6.915250259835515, 79.9739798401774),
              zoom: 13,
            ),
            polylines: {
              Polyline(
                  ...
                  points: [
                    userLocation,
                    const LatLng(6.915250259835515, 79.9739798401774),
                  ]),
            },
            markers: {
              Marker(
              ...
              Marker(
                ...
                position: const LatLng(6.915250259835515, 79.9739798401774),
                infoWindow:
                    const InfoWindow(title: 'Popular Paints and Hardware'),
