...
class MapsPage2 extends StatefulWidget {
  const MapsPage2({super.key});
  static const String id = 'map_screen_2';

  @override
  State<MapsPage2> createState() => _MapsPage2State();
}
        ...
        builder: (context, snapshot) {
          ...
          return GoogleMap(
            initialCameraPosition: const CameraPosition(
              target: LatLng(6.896215466755927, 79.96036310010267),
              zoom: 13,
            ),
            polylines: {
              Polyline(
                  ...
                  points: [
                    userLocation,
                    const LatLng(6.896215466755927, 79.96036310010267),
                  ]),
            },
            markers: {
              Marker(
              ...
              Marker(
                ...
                position: const LatLng(6.896215466755927, 79.96036310010267),
                infoWindow: const InfoWindow(title: 'Malabe Hardware Stores'),
