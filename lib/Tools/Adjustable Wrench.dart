...
class AdjustableWrenchTool extends StatefulWidget {
  const AdjustableWrenchTool({super.key});

  static const String id = 'adjustable_wrench_tool';

  @override
  State<AdjustableWrenchTool> createState() => _AdjustableWrenchToolState();
}

class _AdjustableWrenchToolState extends State<AdjustableWrenchTool> {
  @override
